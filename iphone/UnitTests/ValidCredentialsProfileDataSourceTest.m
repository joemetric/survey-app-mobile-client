...
-(void)setUp{
	...
	account.gender = @"F";
	account.birthdate = [dateFormatter dateFromString:@"3 Mar 1953"];
...
-(void) testReturnsCorrectCellForIndexPath{
	...
	[self assertCorrectValue:@"1953-03-03 00:00:00 +0000" forSection:1 row:1 label:@"date of birth"];	
	[self assertCorrectValue:@"$12345" forSection:1 row:2 label:@"income"];
